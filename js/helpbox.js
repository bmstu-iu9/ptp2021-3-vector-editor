        ...
        helppage.innerHTML = 
            '<div class="instruction big_height"> \
                <p class="help_text full_width"> \
                    ...
                    4)Изменение стиля контура объекта, изменение стиля углов объекта, изменение стиля концов линий (слева направо). <br> \
            ...
            <div class="instruction"> \
                <p class="help_text">\
                    Инструмент <b>"Заливка"</b> меняет заливку фигуры или заднего фона на тот цвет, что указан на правой панели. \
                </p> \
