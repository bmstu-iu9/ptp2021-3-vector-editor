...
function help() {
    ...
    if (pagecounter == 1) {
        ...
        helppage.innerHTML =
            '<div class="instruction"> \
                <p class="help_text">\
                    ...
                    При зажатии клавиши <strong>Shift</strong> во время создания эллипса будет рисоваться круг. \
            ...
            <div class="instruction"> \
                <p class="help_text">\
                    ...
                    При зажатии клавиши <strong>Shift</strong> угол наклона создаваемого правильного многоугольника зафиксируется таким образом, что его нижняя сторона будет направлена горизонтально. \
                </p> \
            ...
            <div class="instruction"> \
                <p class="help_text full_width">\
                    ...
                    Для этого нужно при зажатой на вершине правильного многоугольника левой кнопке мыши нажимать кнопки стрелок <strong>Вверх</strong> и <strong>Вниз</strong>. \
        ...
        helppage.innerHTML =
            ...
            <div class="instruction"> \
                <p class="help_text full_width">\
                    Количество вариантов шага звёздчатого многоугольника определяется по формуле <b>(количество вершин - 3) / 2</b>. \
        ...
        helppage.innerHTML =
            '<div class="instruction"> \
                <p class="help_text"> \
                    ...
                    На верхней панели появятся его характеристики - угол наклона, координаты, шрифт и его размер. Можно использовать пользовательские шрифты, поддерживаемые браузером, а также предложенными шрифтами из выпадающего списка.\
                </p> \
        ...
        helppage.innerHTML =
            '<div class="instruction big_height"> \
                <p class="help_text full_width"> \
                    ...
                    Для быстрого переименования слоя удерживайте <strong>Ctrl</strong> при нажатии на название.\
                </p> \
            </div> \
            <div class="instruction"> \
                <p class="help_text">\
